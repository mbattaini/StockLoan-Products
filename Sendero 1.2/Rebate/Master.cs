...
namespace Anetics.Rebate
{
  public class Master
  {
    const string APPLICATION_NAME = "Rebate";
    ...
    public Master(int logLevel, string logFilePath)
    {
      ...
      try
      { 
        rebateMain = new RebateMain(dbCnStr);
      }
      catch (Exception e)
      {
    ...
    public void OnStart()
    {
      ...
      KeyValue.Set("RebateServiceStartTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
    ...
    public void OnStop()
    {
      ...
      KeyValue.Set("RebateServiceStopTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
  }
}
