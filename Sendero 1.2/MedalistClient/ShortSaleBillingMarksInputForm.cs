...
{
	public class ShortSaleBillingMarksInputForm : System.Windows.Forms.Form
	{
		...
		public ShortSaleBillingMarksInputForm (MainForm mainForm, string FromDate, string ToDate, string groupCode, string accountNumber)
		{    
			InitializeComponent();     
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ShortSaleBillingMarksInputForm));
			...
			this.CloseButton.Location = new System.Drawing.Point(268, 236);
			...
			this.StatusMessageLabel.Location = new System.Drawing.Point(83, 176);
			...
			this.ToLabel.Location = new System.Drawing.Point(72, 38);
			...
			this.FromLabel.Location = new System.Drawing.Point(48, 10);
			...
			// FromDatePicker
			// 
			this.FromDatePicker.Location = new System.Drawing.Point(111, 8);
			...
			// ToDatePicker
			// 
			this.ToDatePicker.Location = new System.Drawing.Point(111, 36);
			...
			this.OverwriteCheckBox.Location = new System.Drawing.Point(127, 136);
			this.OverwriteCheckBox.Name = "OverwriteCheckBox";
			this.OverwriteCheckBox.Size = new System.Drawing.Size(184, 18);
			this.OverwriteCheckBox.TabIndex = 43;
			this.OverwriteCheckBox.Text = "Overwrite Existing Charges:";
			// 
			// GroupCodeCombo
			// 
			...
			this.GroupCodeCombo.Location = new System.Drawing.Point(111, 68);
			...
			this.AccountCombo.Location = new System.Drawing.Point(111, 96);
			...
			this.AccountLabel.Location = new System.Drawing.Point(40, 100);
			this.AccountLabel.Name = "AccountLabel";
			this.AccountLabel.Size = new System.Drawing.Size(68, 16);
			...
			this.BackgroundPanel.Controls.Add(this.GroupCodeLabel);
			this.BackgroundPanel.Dock = System.Windows.Forms.DockStyle.Fill;
			this.BackgroundPanel.DockPadding.All = 1;
			this.BackgroundPanel.Location = new System.Drawing.Point(1, 1);
			this.BackgroundPanel.Name = "BackgroundPanel";
			this.BackgroundPanel.Size = new System.Drawing.Size(436, 277);
			this.BackgroundPanel.TabIndex = 51;
			// 
			// GroupCodeLabel
			// 
			this.GroupCodeLabel.BackColor = System.Drawing.SystemColors.ControlLight;
			this.GroupCodeLabel.Location = new System.Drawing.Point(16, 71);
			this.GroupCodeLabel.Name = "GroupCodeLabel";
			this.GroupCodeLabel.Size = new System.Drawing.Size(88, 16);
			this.GroupCodeLabel.TabIndex = 46;
			...
			// 
			// ShortSaleBillingMarksInputForm
			// 
			...
			this.Name = "ShortSaleBillingMarksInputForm";
			this.Text = "ShortSale - Billing - MarkUp";
			this.Load += new System.EventHandler(this.ShortSaleBillingMarksInputForm_Load);
			this.Closed += new System.EventHandler(this.ShortSaleBillingMarksInputForm_Closed);
			this.Paint += new System.Windows.Forms.PaintEventHandler(this.ShortSaleBillingMarksInputForm_Paint);
		...
		private void ShortSaleBillingMarksInputForm_Load(object sender, System.EventArgs e)
		{       
		...
		private void SubmitButton_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				recordsUpdated  = mainForm.RebateAgent.ShortSaleBillingSummaryMarkSet(
		...
		private void ShortSaleBillingMarksInputForm_Closed(object sender, System.EventArgs e)
		{
			mainForm.Refresh();
		}
		...
		private void ShortSaleBillingMarksInputForm_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
