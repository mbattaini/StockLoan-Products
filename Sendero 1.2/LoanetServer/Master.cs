...
namespace Anetics.Loanet
{
  public class Master
  {
    const string APPLICATION_NAME = "LoanetServer";
    ...
    public static string ContractsBizDate = "";
		public static	bool	 IsS3Active = false;
    ...
    private LoanetMain loanetMain;
    private ProcessAgent coOpAgent;
    ...
    public Master(int logLevel, string logFilePath)
    {
      ...
      try
      { 
        loanetMain = new LoanetMain(dbCnStr);
        coOpAgent = new ProcessAgent(dbCnStr);
      }
      catch (Exception e)
      {
    ...
    public void OnStart()
    {
      ...
      try
      {
        ...
        coOpAgent = new ProcessAgent(dbCnStr);
        RemotingServices.Marshal(coOpAgent, "ProcessAgent." + channelFormatter);
    ...
    public void OnStop()
    {
      ...
      try
      {
        coOpAgent.Stop(); // Fires event for client notification.
        ...
        RemotingServices.Disconnect(coOpAgent);
        coOpAgent = null;
