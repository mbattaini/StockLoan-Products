...
~SPLIT~<spUserViewEditBookGroup.prc>
...
~SPLIT~<Add-IsActive-Col-To-tbCountries.sql>
...
~SPLIT~<Add-IsActive-Col-To-tbCurrencies.sql>
...
CREATE Procedure dbo.spSecIdSymbolLookup
...
GRANT  EXECUTE  ON [dbo].[spBookParentGet]  TO [roleMedalist]
GO

~SPLIT~<spBookParentGet.prc>
...
~SPLIT~<spBookGroupGet-DUPLICATE.prc>
...
~SPLIT~<spContractBizDateList.prc>
...
~SPLIT~<spContractBizDateRoll.prc>
...
~SPLIT~<spLoanetClientInsert.prc>
...
~SPLIT~<spLoanetClientLongInsert.prc>
...
~SPLIT~<spLoanetClientLongPurge.prc>
...
~SPLIT~<spLoanetCollateralInsert.prc>
...
~SPLIT~<spLoanetCollateralPurge.prc>
...
~SPLIT~<tbLoanetContractControl.tab>
...
~SPLIT~<spLoanetContractControlSet.prc>
...
~SPLIT~<spLoanetContractInsert.prc>
...
~SPLIT~<spLoanetContractPurge.prc>
...
~SPLIT~<spLoanetRecallInsert.prc>
...
~SPLIT~<spLoanetBookLongUpdate.prc>
...
~SPLIT~<spLoanetContractUpdate.prc>
...
~SPLIT~<spLoanetRecallUpdate.prc>
...
~SPLIT~<tbLoanetCoOpMessages.tab>
...
~SPLIT~<spLoanetCoOpMessageInsert.prc>
...
~SPLIT~<spLoanetCoOpMessageGet.prc>
...
~SPLIT~<spLoanetDatagramTransactionUpdate.prc>
...
~SPLIT~<spRecallActivityInsert.prc>
...
~SPLIT~<spLoanetContractRecallUpdate.prc>
...
~SPLIT~<spRecallIndicatorsGet.prc>
...
~SPLIT~<DropspShortSaleLocates.sql>
...
~SPLIT~<spShortSaleLocateGet.prc>
...
~SPLIT~<DropspShortSaleLocateDates.sql>
...
~SPLIT~<spShortSaleTradeDates.prc>
...
GRANT  EXECUTE  ON [dbo].[spInventoryHistoryGet]  TO [roleMedalist]
GO

~SPLIT~<spInventoryHistoryGet.prc>
...
~SPLIT~<spShortSaleLocateLookup.prc>
...
~SPLIT~<spShortSaleLocateRequest.prc>
...
~SPLIT~<spShortSaleLocateSet.prc>
...
~SPLIT~<spThresholdControlSet.prc>
...
CREATE Procedure dbo.spThresholdItemSet
	@BizDate datetime,
	@Exchange char(4),
	@Symbol varchar(12),
...
~SPLIT~<tbInventoryFileDataMasks.tab>
...
~SPLIT~<spInventoryFileDataMaskGet.prc>
...
~SPLIT~<spInventoryFileDataMaskList.prc>
...
~SPLIT~<spInventoryFileDataMaskSet.prc>
...
CREATE Procedure dbo.spBoxPositionGet
	@BizDate  datetime,
	@SecId varchar(12),
...
CREATE Procedure dbo.spBoxPositionStateSet
	@BizDate  datetime,
	@BookGroup  varchar(10)
As
Begin
...
~SPLIT~<spBoxPositionStateSet.prc>
...
CREATE Procedure dbo.spBoxPositionPurge
	@BizDate  datetime,
	@BookGroup  varchar(10)
As
Begin
...
~SPLIT~<spBoxPositionItemSet.prc>
...
GRANT  EXECUTE  ON [dbo].[spBoxFailHistoryGet]  TO [roleMedalist]
GO

~SPLIT~<spBoxFailHistoryGet.prc>
...
CREATE Procedure dbo.spBoxLocationGet
	@SecId varchar(12) = Null,
	@BookGroup varchar(10) = Null,
...
CREATE Procedure dbo.spBoxLocationStateSet
...
~SPLIT~<spBoxLocationStateSet.prc>
...
CREATE Procedure dbo.spBoxLocationPurge
...
~SPLIT~<spBoxLocationItemSet.prc>
...
~SPLIT~<spBookCreditAvailableGet.prc>
...
~SPLIT~<PositionBoxSummaryMods.sql>
...
~SPLIT~<spLoanetRecallDebitUpdate.prc>
...
~SPLIT~<spLoanetDatagramDebitUpdate.prc>
...
~SPLIT~<Add-IsActive-Col-To-tbdeskTypes.sql>
...
~SPLIT~<Add-IsActive-Col-To-tbFirms.sql>
...
~SPLIT~<Add-IsActive-Col-To-tbHolidays.sql>
...
~SPLIT~<tbInventoryPublisher.tab>
...
~SPLIT~<spInventoryPublisherGet.prc>
...
~SPLIT~<spInventoryPublisherSet.prc>
...
GRANT  EXECUTE  ON [dbo].[spBorrowHardChanges]  TO [roleMedalist]
GO

~SPLIT~<spBorrowHardChanges.prc>
...
~SPLIT~<spInventoryDeskListGet.prc>
...
~SPLIT~<tbBankLoanActivityTypes.tab>
...
And	(  (BA.Status In ('PC', 'RC', 'PF', 'RF', 'RC', 'EE') AND @BizDateBank < BA. ActTime)
	OR
	BA.Status Not in ('PC','RC', 'PF', 'RF', 'EE'))
...
~SPLIT~<spBankLoanActivityGet.prc>
...
~SPLIT~<spBankLoanActivitySet.prc>
...
~SPLIT~<spBankLoanActivityTypeGet.prc>
...
~SPLIT~<spBankLoanBizDateRoll.prc>
...
~SPLIT~<spBankLoanPledgeSummaryGet.prc>
...
~SPLIT~<spBankLoanReleaseSummaryGet.prc>
...
GRANT  EXECUTE  ON [dbo].[spBankLoansGet]  TO [roleMedalist]
GO

~SPLIT~<spBankLoansGet.prc>
...
~SPLIT~<spLoanetDatagramBankLoanUpdate.prc>
...
~SPLIT~<InitBankLoanValues.sql>

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[spDeskSet]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[spDeskSet]
GO
...
CREATE PROCEDURE dbo.spDeskSet 
	@Desk varchar(12),
	@FirmCode varchar(5),
	@CountryCode varchar(5),
	@DeskTypeCode varchar(5)
...
Update		tbDesks
Set		FirmCode = IsNull(@FirmCode, FirmCode),
		CountryCode = IsNull(@CountryCode, CountryCode),
		DeskTypeCode = IsNull(@DeskTypeCode, DeskTypeCode)			
Where		Desk = @Desk
...
GRANT  EXECUTE  ON [dbo].[spDeskSet]  TO [roleMedalist]
GO
