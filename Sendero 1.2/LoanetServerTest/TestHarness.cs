...
namespace Anetics.Loanet
{
  class TestHarness
  {
    ...
    static void Main(string[] args)
    {
      ...
      Console.WriteLine("");
      Console.WriteLine("Session started, type 'exit' then press <return> to exit, or...");
      Console.WriteLine("");
      Console.WriteLine("Type 'start' then press <return> to start the server.");
      Console.WriteLine("Type 'stop' then press <return> to stop the server.");
      Console.WriteLine("");
