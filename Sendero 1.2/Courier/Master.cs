...
namespace Anetics.Courier
{
  public class Master
  {
    ...
    public Master(int logLevel, string logFilePath)
    {
      ...
      try
      { 
        courierMain = new CourierMain(dbCnStr);
      }
      catch (Exception e)
      {
    ...
    public void OnStart()
    {
      ...
      KeyValue.Set("CourierServiceStartTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
    ...
    public void OnStop()
    {
      ...
      KeyValue.Set("CourierServiceStopTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
  }
}
