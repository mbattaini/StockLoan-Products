...
namespace DatabaseFunctions
{
    public class SenderoDatabaseFunctions
    {
        ...
        public static void BoxPositionClearingOvernightSiacInsert(string bizDate, string bookGroup, string secId, string pdqQuantity, string dbCnStr)
        {
            SqlConnection dbCn = new SqlConnection(dbCnStr);     

            try
            {
                SqlCommand dbCmd = new SqlCommand("dbo.spBoxPositionClearingOvernightSiacItemSet", dbCn);
                dbCmd.CommandType = CommandType.StoredProcedure;
                ...
                SqlParameter paramPdqQuantity = dbCmd.Parameters.Add("@PdqQuantity", SqlDbType.BigInt);
                paramPdqQuantity.Value = pdqQuantity;
