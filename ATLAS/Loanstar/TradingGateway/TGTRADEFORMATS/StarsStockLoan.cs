...
namespace StockLoan.TGTradeFormats
{
    public class StarsStockLoan
    {
           ...
           string collateralised)
        {
            ...
            xmlMessage += "<TradeDate>" + DateTime.Parse(tradeDate).ToString("yyyy-MM-dd") + "</TradeDate>";
            ...
            xmlMessage += "<DeliveryRisk>" + deliveryRisk + "</DeliveryRisk>";
            ...
            xmlMessage += "<StartDate>" + DateTime.Parse(startDate).ToString("yyyy-MM-dd") + "</StartDate>";
            xmlMessage += "<EndDate>" + DateTime.Parse(endDate).ToString("yyyy-MM-dd") + "</EndDate>";
