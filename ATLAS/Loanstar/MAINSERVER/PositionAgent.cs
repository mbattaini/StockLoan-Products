...
namespace StockLoan.Main
{
    public class PositionAgent : MarshalByRefObject, IPosition
    {
        ...
        public DataSet ContractCollateralCodes()
        {
            ...
            try
            {
                dbCmd = new SqlCommand("spCollateralCodesGet", new SqlConnection(dbCnStr));
                dbCmd.CommandType = CommandType.StoredProcedure;

                dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(ds, "CollateralCodes");

                ds.RemotingFormat = SerializationFormat.Binary;
            }
            catch (Exception e)
            {
                Log.Write(e.Message + " [PositionAgent.ContractDeliveryTypesGet]", Log.Error, 1);
            }

            return ds;
        }

        public DataSet ContractDeliveryTypesGet()
        {
            SqlDataAdapter dataAdapter = null;
            SqlCommand dbCmd = null;
            ...
            try
            {
                dbCmd = new SqlCommand("spContractDeliveryTypeGet", new SqlConnection(dbCnStr));
                dbCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet DealItemGet(string bizDate, string dealId, short utcOffset)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    SqlParameter paramDeliveryType = dbCmd.Parameters.Add("@DeliveryType", SqlDbType.VarChar, 10);
                    paramDeliveryType.Value = deliveryType;
                }

                if (!tradeRoute.Equals(""))
                {
                    SqlParameter paramTradeRoute = dbCmd.Parameters.Add("@TradeRoute", SqlDbType.VarChar, 100);
                    paramTradeRoute.Value = tradeRoute;
                }

                if (!prepayRate.Equals(""))
                {
                    SqlParameter paramPrePayRate = dbCmd.Parameters.Add("@PrepayRate", SqlDbType.Decimal);
                    paramPrePayRate.Value = prepayRate;
                }

                if (!preparyDate.Equals(""))
                {
                    SqlParameter paramPrePayDate = dbCmd.Parameters.Add("@PrepayDate", SqlDbType.DateTime);
                    paramPrePayDate.Value = preparyDate;
                }
        ...
        {
            if (!settleDateActual.Equals("") && !settleDateActual.Equals(Master.BizDate))
            {
                throw new Exception("Current buisness settlement only, any settlement before today must be done in as-of screen");
            }
        ...
        public string MarkAsOfSet(
            ...
            string actUserId)
        {
            int asOfDayCount = int.Parse(KeyValue.Get("AsOfDayLimit", "30", dbCnStr));
            ...
            if (Math.Abs(DateTime.Parse(tradeDate).Subtract(DateTime.Parse(Master.BizDate)).TotalDays) >= asOfDayCount)
            {
                throw new Exception("Cannot process a as-opf mark greater than 30 days.");
            }
        ...
        public string ReturnAsOfSet(string tradeDate, string settleDate, string bookGroup, string book, string contractId, string contractType, string quantity, string returnId, string actUserId)
        {
            ...
            if (Math.Abs(DateTime.Parse(tradeDate).Subtract(DateTime.Parse(Master.BizDate)).TotalDays) >= asOfDayCount)
            {
                throw new Exception("Cannot process a as-opf return greater than 30 days.");
            }
        ...
        public DataSet TransactionsDailiyGet(string bizDate)
        {
            ...
            try
            {
                ...
                SqlCommand dbCmd = new SqlCommand("spTransactionsDailyGet", dbCn);
                dbCmd.CommandType = CommandType.StoredProcedure;
                ...
                dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsTransactions, "Transactions");

                dsTransactions.RemotingFormat = SerializationFormat.Binary;
            }
            catch (Exception error)
            {
                Log.Write(error.Message, 1);
        ...
        public DataSet CashGet(string bookGroup, string contractId, short utcOffset)
        {
            ...
            try
            {
                ...
                SqlCommand dbCmd = new SqlCommand("spCashGet", dbCn);
                dbCmd.CommandType = CommandType.StoredProcedure;
                ...
                dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsCash, "Cash");

                dsCash.RemotingFormat = SerializationFormat.Binary;
            }
            catch (Exception error)
            {
                Log.Write(error.Message, 1);
        ...
        public void CashSet(string bookGroup, string book, string contractId, string contractType, string amountActual, string settleDate, string actUserId)
        {
            SqlConnection dbCn = new SqlConnection(dbCnStr);

            SqlCommand dbCmd = new SqlCommand("spCashSet", dbCn);
            dbCmd.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                if (!amountActual.Equals(""))
                {
                    SqlParameter paramAmountActual = dbCmd.Parameters.Add("@AmountActual", SqlDbType.Decimal);
                    paramAmountActual.Value = amountActual;
                }
