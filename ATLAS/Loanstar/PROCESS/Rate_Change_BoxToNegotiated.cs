...
{
  public class Rate_Change_BoxToNegotiated
  {
    private string message = "75";

    public Rate_Change_BoxToNegotiated()
    {
    }
    ...
    public ProcessStatusEventArgs Request(
      ...
      string  book,
      string  contractId,
      decimal negotiatedInterestRate,
      string  actUserId)
    {
      ...
      negotiatedInterestRate = negotiatedInterestRate * 1000;
      message += negotiatedInterestRate.ToString("00000");
      negotiatedInterestRate = negotiatedInterestRate / 1000;
      ...
      ProcessStatusEventArgs processStatusEventArgsItem = new ProcessStatusEventArgs(
        ...
        "L",
        "BTN",
        "Box to negotaited rate change to rate: " + negotiatedInterestRate.ToString("##.000"),
        "",
        actUserId,
        false, 
        bookGroup,
      ...
      for (int index = 0; index < message.Length; index ++)
      {
        if (message[index].Equals('X'))
        {
          switch (index)
          {
            ...
            case 33: error += Errors.CONTRACT_TYPE_ERROR;
              break;
