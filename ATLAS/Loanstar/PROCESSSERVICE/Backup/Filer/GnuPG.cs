...
namespace Anetics.Common
{
  ...
  public class GnuPG
    ...
    public GnuPG(string homePath, string loadExtension)
    {
      ...
      Log.Write("GnuPG loaded with a home path of '" + homePath + "' and an extension of '" + Tools.ZeroLengthNull(loadExtension) + "'. [GnuPG.GnuPG]", 3);
    }
    ...
    public void DoCommand(string file)
    {
      ...
      Log.Write("Call for " + command.ToString() + " on " + file + ". [GnuPG.DoCommand]", 2);
    ...
    protected string CommandArgs()
    {
      ...
      switch (command)
      {
        case Commands.Encrypt:
          ...
          commandArgs.Append(recipient);
          commandArgs.Append(" --yes --encrypt-files ");
      ...
      Log.Write("CommandArgs returning: " + commandArgs.ToString() + " [GnuPG.CommandArgs]", 3);
