  ...
  public class Master
  {
    ...
    public void OnStart()
    {
      ...
      catch (Exception e)
      {
        ...
        KeyValue.Set("MedalistServiceStartTime", "System", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCn);
    }
    ...
    public void OnStop()
    {
      ...
      try
      {
        ...
        KeyValue.Set("MedalistServiceStopTime", "System", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCn);
      }
      catch (Exception e)
      {
        Log.Write(e.Message + " [Master.OnStop]", Log.Error, 1);
