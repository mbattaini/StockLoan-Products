...
{
	partial class AnalysisContractSummaryCounterpartyForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AnalysisContractSummaryCounterpartyForm));
			...
			this.panel1.Size = new System.Drawing.Size(783, 34);
			...
			// 
			// AnalysisContractSummaryCounterpartyForm
			// 
			...
			this.Name = "AnalysisContractSummaryCounterpartyForm";
			this.Text = "Analysis - Contract Summary Counterparty";
			this.VisualStyleHolder = C1.Win.C1Ribbon.VisualStyle.Office2007Silver;
			this.Load += new System.EventHandler(this.AnalysisContractSummaryCounterpartyForm_Load);
