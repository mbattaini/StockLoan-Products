...
namespace CentralClient
{
    public class Excel
    {
        ...
        public static void ExportSheetsToExcel(XLSheet [] xlSheets, int numOfSheets, string fileName)
        {
            C1XLBook book = new C1XLBook();
            ...
            try
            {
                ...
                {
                    book.Sheets.Add(xlSheets[count]);
                }
            ...
            {
                Log.Write(e.Message + " [Excel.ExportSheetsToExcel]", 1);
            }
        }
