...
namespace StockLoan.Main
{
	...
	{
        DataSet ContractCollateralCodes();
        DataSet ContractDeliveryTypesGet();
        
        DataSet FundsGet();
		DataSet FundingRatesGet(string bizDate);
        DataSet FundingRateResearchGet(string startDate, string stopDate, string fund);
		...
		DataSet DealItemGet(string bizDate, string dealId, short utcOffset);
        ...
        DataSet ContractResearchDataGet(string startDate, string stopDate, string bookGroup, string book, string contractId, string secId);
        ...
        DataSet TransactionsDailiyGet(string bizDate);

        DataSet CashGet(string bookgroup, string contractid, short utcOffset);
        void CashSet(string bookgroup, string book, string contractid, string contractType, string amountActual, string settleDate, string actUserId);
	}
