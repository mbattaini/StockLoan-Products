...
// 
namespace WorldWideClient.ServiceSecurity {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceSecurity.ISecurityService")]
    public interface ISecurityService {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/ISecurityService/UserPasswordResetCheck", ReplyAction="http://tempuri.org/ISecurityService/UserPasswordResetCheckResponse")]
        System.IAsyncResult BeginUserPasswordResetCheck(string userId, string ePassword, string sourceAddress, int resetReq, System.AsyncCallback callback, object asyncState);
        
        int EndUserPasswordResetCheck(System.IAsyncResult result);
        ...
        System.IAsyncResult BeginUserValidate(string userId, string ePassword, bool pwdEncrypted, System.AsyncCallback callback, object asyncState);
        
        bool EndUserValidate(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISecurityServiceChannel : WorldWideClient.ServiceSecurity.ISecurityService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UserPasswordResetCheckCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        public UserPasswordResetCheckCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SecurityServiceClient : System.ServiceModel.ClientBase<WorldWideClient.ServiceSecurity.ISecurityService>, WorldWideClient.ServiceSecurity.ISecurityService {
        ...
        private BeginOperationDelegate onBeginUserPasswordResetCheckDelegate;
        
        private EndOperationDelegate onEndUserPasswordResetCheckDelegate;
        
        private System.Threading.SendOrPostCallback onUserPasswordResetCheckCompletedDelegate;
        ...
        public event System.EventHandler<UserPasswordResetCheckCompletedEventArgs> UserPasswordResetCheckCompleted;
        ...
        System.IAsyncResult WorldWideClient.ServiceSecurity.ISecurityService.BeginUserPasswordChange(string userId, string oldEPassword, string newEPassword, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUserPasswordChange(userId, oldEPassword, newEPassword, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool WorldWideClient.ServiceSecurity.ISecurityService.EndUserPasswordChange(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginUserPasswordChange(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).BeginUserPasswordChange(userId, oldEPassword, newEPassword, callback, asyncState);
        }
        
        private object[] OnEndUserPasswordChange(System.IAsyncResult result) {
            bool retVal = ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).EndUserPasswordChange(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WorldWideClient.ServiceSecurity.ISecurityService.BeginUserPasswordReset(string userId, string newEPassword, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUserPasswordReset(userId, newEPassword, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool WorldWideClient.ServiceSecurity.ISecurityService.EndUserPasswordReset(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginUserPasswordReset(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).BeginUserPasswordReset(userId, newEPassword, callback, asyncState);
        }
        
        private object[] OnEndUserPasswordReset(System.IAsyncResult result) {
            bool retVal = ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).EndUserPasswordReset(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WorldWideClient.ServiceSecurity.ISecurityService.BeginUserPasswordResetCheck(string userId, string ePassword, string sourceAddress, int resetReq, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUserPasswordResetCheck(userId, ePassword, sourceAddress, resetReq, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int WorldWideClient.ServiceSecurity.ISecurityService.EndUserPasswordResetCheck(System.IAsyncResult result) {
            return base.Channel.EndUserPasswordResetCheck(result);
        }
        
        private System.IAsyncResult OnBeginUserPasswordResetCheck(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string userId = ((string)(inValues[0]));
            string ePassword = ((string)(inValues[1]));
            string sourceAddress = ((string)(inValues[2]));
            int resetReq = ((int)(inValues[3]));
            return ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).BeginUserPasswordResetCheck(userId, ePassword, sourceAddress, resetReq, callback, asyncState);
        }
        
        private object[] OnEndUserPasswordResetCheck(System.IAsyncResult result) {
            int retVal = ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).EndUserPasswordResetCheck(result);
            return new object[] {
                    retVal};
        }
        
        private void OnUserPasswordResetCheckCompleted(object state) {
            if ((this.UserPasswordResetCheckCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.UserPasswordResetCheckCompleted(this, new UserPasswordResetCheckCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void UserPasswordResetCheckAsync(string userId, string ePassword, string sourceAddress, int resetReq) {
            this.UserPasswordResetCheckAsync(userId, ePassword, sourceAddress, resetReq, null);
        }
        
        public void UserPasswordResetCheckAsync(string userId, string ePassword, string sourceAddress, int resetReq, object userState) {
            if ((this.onBeginUserPasswordResetCheckDelegate == null)) {
                this.onBeginUserPasswordResetCheckDelegate = new BeginOperationDelegate(this.OnBeginUserPasswordResetCheck);
            }
            if ((this.onEndUserPasswordResetCheckDelegate == null)) {
                this.onEndUserPasswordResetCheckDelegate = new EndOperationDelegate(this.OnEndUserPasswordResetCheck);
            }
            if ((this.onUserPasswordResetCheckCompletedDelegate == null)) {
                this.onUserPasswordResetCheckCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnUserPasswordResetCheckCompleted);
            }
            base.InvokeAsync(this.onBeginUserPasswordResetCheckDelegate, new object[] {
                        userId,
                        ePassword,
                        sourceAddress,
                        resetReq}, this.onEndUserPasswordResetCheckDelegate, this.onUserPasswordResetCheckCompletedDelegate, userState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WorldWideClient.ServiceSecurity.ISecurityService.BeginUserValidate(string userId, string ePassword, bool pwdEncrypted, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginUserValidate(userId, ePassword, pwdEncrypted, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool WorldWideClient.ServiceSecurity.ISecurityService.EndUserValidate(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginUserValidate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string userId = ((string)(inValues[0]));
            string ePassword = ((string)(inValues[1]));
            bool pwdEncrypted = ((bool)(inValues[2]));
            return ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).BeginUserValidate(userId, ePassword, pwdEncrypted, callback, asyncState);
        }
        
        private object[] OnEndUserValidate(System.IAsyncResult result) {
            bool retVal = ((WorldWideClient.ServiceSecurity.ISecurityService)(this)).EndUserValidate(result);
            return new object[] {
                    retVal};
        }
        ...
        public void UserValidateAsync(string userId, string ePassword, bool pwdEncrypted) {
            this.UserValidateAsync(userId, ePassword, pwdEncrypted, null);
        }
        
        public void UserValidateAsync(string userId, string ePassword, bool pwdEncrypted, object userState) {
            ...
            base.InvokeAsync(this.onBeginUserValidateDelegate, new object[] {
                        userId,
                        ePassword,
                        pwdEncrypted}, this.onEndUserValidateDelegate, this.onUserValidateCompletedDelegate, userState);
        }
        ...
        protected override WorldWideClient.ServiceSecurity.ISecurityService CreateChannel() {
            return new SecurityServiceClientChannel(this);
        }
        
        private class SecurityServiceClientChannel : ChannelBase<WorldWideClient.ServiceSecurity.ISecurityService>, WorldWideClient.ServiceSecurity.ISecurityService {
            
            public SecurityServiceClientChannel(System.ServiceModel.ClientBase<WorldWideClient.ServiceSecurity.ISecurityService> client) : 
                    base(client) {
            }
            ...
            public System.IAsyncResult BeginUserPasswordResetCheck(string userId, string ePassword, string sourceAddress, int resetReq, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[4];
                _args[0] = userId;
                _args[1] = ePassword;
                _args[2] = sourceAddress;
                _args[3] = resetReq;
                System.IAsyncResult _result = base.BeginInvoke("UserPasswordResetCheck", _args, callback, asyncState);
                return _result;
            }
            
            public int EndUserPasswordResetCheck(System.IAsyncResult result) {
                object[] _args = new object[0];
                int _result = ((int)(base.EndInvoke("UserPasswordResetCheck", _args, result)));
                return _result;
            }
            
            public System.IAsyncResult BeginUserValidate(string userId, string ePassword, bool pwdEncrypted, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[3];
                _args[0] = userId;
                _args[1] = ePassword;
                _args[2] = pwdEncrypted;
                System.IAsyncResult _result = base.BeginInvoke("UserValidate", _args, callback, asyncState);
                return _result;
            }
            
            public bool EndUserValidate(System.IAsyncResult result) {
                object[] _args = new object[0];
                bool _result = ((bool)(base.EndInvoke("UserValidate", _args, result)));
                return _result;
            }
        }
    }
