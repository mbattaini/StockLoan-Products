...
namespace WorldWideClient
{
	public partial class SecurityMasterControl : UserControl
	{
		...
		public SecurityMasterControl()
		{
			...
			secMasterBookGroupToolBar.ShowBookCombo = false;
			secMasterBookGroupToolBar.ShowBusinessDate = false;			
			secMasterBookGroupToolBar.ShowExportToCombo = false;			
			secMasterBookGroupToolBar.FunctionName = System.Reflection.MethodBase.GetCurrentMethod().ReflectedType.Name;
        ...
        {
            if(!secMasterBookGroupToolBar.BookGroup.Equals(""))
			{
                ...
                secMasterClient.SecMasterGetAsync(
                	...
                	"", 
                	"", 
                	secMasterBookGroupToolBar.BookGroup,
                	"", 
			...
			{
				SystemEventWindow.Show("Please select bookgroup.");
			}
        }
	}
}