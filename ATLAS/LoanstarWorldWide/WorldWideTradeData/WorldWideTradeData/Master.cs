...
namespace StockLoan.WorldWideTradeDataService
{
  ...
  public class Master
  {
    const string APPLICATION_NAME = "WorldWideTradeData";
    ...
    private WorldWideTradeDataMain worldWideTradeDataMain;
    ...
    public Master(int logLevel, string logFilePath)
    {
        ...
        try
        {
            worldWideTradeDataMain = new WorldWideTradeDataMain(dbCnStr);
        }
        catch (Exception e)
        {
