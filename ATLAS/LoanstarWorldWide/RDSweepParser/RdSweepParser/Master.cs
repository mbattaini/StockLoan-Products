...
namespace StockLoan.InventoryService
{
  ...
  public class Master
  {
    const string APPLICATION_NAME = "InventoryService"; 
    ...
    private InventoryServiceMain inventoryServiceMain;
    ...
    public Master(int logLevel, string logFilePath)
    {
      ...
      try
      { 
        inventoryServiceMain = new InventoryServiceMain(dbCnStr);    // Added new argument: WorldWideDbCnStr 
      }
      catch (Exception e)
      {
    ...
    public void OnStart()
    {
      ...
      KeyValue.Set("InventoryServiceStartTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
    ...
    public void OnStop()
    {
      ...
      KeyValue.Set("InventoryServiceStopTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
  }
}
