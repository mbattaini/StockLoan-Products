...
namespace StockLoan.WorldWideDataService
{
  ...
  public class Master
  {
    const string APPLICATION_NAME = "WorldWideData"; 
    ...
    private WorldWideDataMain worldWideDataMain;
    ...
    public Master(int logLevel, string logFilePath)
    {
      ...
      try
      { 
        worldWideDataMain = new WorldWideDataMain(dbCnStr, worldwideDbCnStr);    // Added new argument: WorldWideDbCnStr 
      }
      catch (Exception e)
      {
    ...
    public void OnStart()
    {
      ...
      KeyValue.Set("WorldWideDataServiceStartTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
    ...
    public void OnStop()
    {
      ...
      KeyValue.Set("WorldWideDataServiceStopTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
  }
}
