...
namespace StockLoan.ParsingFiles
{
    public class EasyBorrowFormat
    {
        ...
        public void EasyBorrowBroadRidgeFileList()
        {
            ...
            try
            {
                dsEasyBorrow = BorrowEasyListGet(bizDate, dbCnStr);

                string fileName = StockLoan.DomesticBoxInformation.BDBoxInformationMain.TempPath + EasyBorrowFileName(correspondentId, bizDate);
                ...
                Email.Send(KeyValue.Get("BroadRigdeETBEmailTo", "mbattaini@penson.com;bhall@penson.com;", dbCnStr),
