...
namespace StockLoanWebServices
{
    ...
    public class PositionService : IPosition
    {
        ...
        public byte[] BorrowEasyListGet(string bizDate, string bookGroup, string recCount)
        {
            //DChen 2012-04-30  Create spBorrowEasyList WebService... for DashApplication Silverlight Client to access.
            //DChen             Returns today's ETB list 
            //DChen             Exec dbo.spBorrowEasyList @TradeDate = '2012-04-23' 
            ...
            try
            {
                ...
                dbCmd = new SqlCommand("spBorrowEasyList", dbCn);
                dbCmd.CommandType = CommandType.StoredProcedure;
                dbCmd.CommandTimeout = 900;
                //dbCmd = new SqlCommand("Select Top " + recCount.ToString() + " * From dbo.tbBorrowEasy With (NOLOCK) Where TradeDate = '2012-04-23' Order By SecId ", dbCn);
                ...
                int count = dsBorrowEasy.Tables["BorrowEasy"].Rows.Count;

                //DChen Debug Error: The maximum message size quota for incoming messages (65536) has been exceeded. 
                //                     To increase the quota, use the MaxReceivedMessageSize property on the appropriate binding element.
                if (dsBorrowEasy.Tables["BorrowEasy"].Rows.Count > 1000)
                {
                    for (int i = count - 1; i > 500; i--)  //1000 rows worked after increased ReadTimeout 
                    {
                        dsBorrowEasy.Tables["BorrowEasy"].Rows.RemoveAt(i);  //DChen debug: Just return 50 rows of ETB list tiems
                    }
                    dsBorrowEasy.AcceptChanges();
                }

            }
            catch (Exception e)
            {
                Log.Write(e.Message + " [PositionAgent.BorrowEasyListGet]", Log.Error, 1);
                throw;
            }

            return Functions.ConvertDataSet(dsBorrowEasy);
        }

        //------ Ported from Medalist PositionAgent.cs ----------
		...
		public byte[] AccountPositionGet(string secId, bool isActive)
		{
        ...
        public byte[] AccountPositionGet(string firm, string locMemo, string accountType,string accountNumber,  string currencyCode, string secId, bool isActive)
		{		
			SqlConnection dbCn = null;
			SqlCommand dbCmd = null;
        ...
        public byte[] AccountsGet(string groupCode)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] AccountsGet(int utcOffset)
        {
        ...
        public byte[] AccountsGet(string firm, string locMemo, string accountType, string accountNumber, string currencyCode, int utcOffset)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] AutoBorrowDataGet(string bizDate, short utcOffset, string userId, string functionPath)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] AutoBorrowItemsGet(int utcOffset, string bizDate)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public void AutoBorrowItemSet(string bookGroup, string listName, string secId, string quantity, string collateralCode,
        ...
        public byte[] AutoBorrowListsGet(int utcOffSet, string bizDate)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public void AutoBorrowListSet(string bookGroup, string listName, string books, string waitTime, bool bookContract,
        ...
        public byte[] AutoBorrowResultsGet(int utcOffSet, string bizDate)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] BankLoanActivityGet(int utcOffset)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] BankLoanReportsGet(int utcOffset)
        {
            SqlConnection dbCn = null;
        ...
        public void BankLoanReportSet(string bookGroup, string reportName, string reportType, string reportHost, string reportHostUserId,
        ...
        public byte[] BankLoanReportsDataGet()
        {
            SqlConnection dbCn = null;
            SqlDataAdapter dataAdapter = null;
            DataSet dataSet = new DataSet();
        ...
        public byte[] BankLoanReportsDataMaskGet(string bookGroup, string reportName, int utcOffset)
        {
            SqlConnection dbCn = null;
            SqlDataAdapter dataAdapter = null;
            DataSet dataSet = new DataSet();
        ...
        public void BankLoanReportsDataMaskSet(string bookGroup, string reportName, string headerFlag, string dataFlag, string trailerFlag,
        ...
        public byte[] BankLoanPledgeSummaryGet(string bizDate)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] BankLoanReleaseSummaryGet(string secId)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] BankLoanDataGet(short utcOffset, string userId, string functionPath)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] BankLoansGet(int utcOffset)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public void BankLoanSet(string bookGroup, string book, string loanDate, string loanType, string activityType, string hairCut,
        ...
        public void BankSet(string bookGroup, string book, string name, string contact, string phone, string fax, string actUserId, bool isActive)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        private byte[] BoxPositionLookup(string secId, string bizDate)
        {
            ...
            try
            {
                dbCn = new SqlConnection(dbCnStr);
                dataSet = new DataSet();
                dbCmd = new SqlCommand("spBoxPositionGet", dbCn);
                dbCmd.CommandType = CommandType.StoredProcedure;
                dbCmd.CommandTimeout = 900; 

                SqlParameter paramBizDate = dbCmd.Parameters.Add("@BizDate", SqlDbType.DateTime);
                paramBizDate.Value = bizDate;   //Master.BizDate;
        ...
        public void BankLoanPledgeSet(string bookGroup, string book, string loanDate, string processId, string loanType, string activityType,
            ...
            try
            {
                ...
                if (bankLoanActivityEventArgs.Status.Equals("PR") && !status.Equals(""))
                {
                    try
                    {
                        ...
                        if (Master.IsSubstitutionActive)
                        {
                            string reservedExcess = "";

                            switch (loanType.ToUpper())
                            {
                                case "C":
                                case "S":
                                    dataSet = substitutionAgent.SubstitutionInventoryDataGet(Master.BizDateExchange, bankLoanActivityEventArgs.SecId);

                                    if (dataSet.Tables["SubstitutionInventory"].Rows.Count == 1)
                                    {
                                        reservedExcess = dataSet.Tables["SubstitutionInventory"].Rows[0]["ReservedExcessQuantity"].ToString();

                                        try
                                        {
                                            if (long.Parse(reservedExcess) >= bankLoanActivityEventArgs.Quantity)
                                            {
                                                reservedExcess = bankLoanActivityEventArgs.Quantity.ToString();
                                            }
                                        }
                                        catch
                                        {
                            ...
                            if (!reservedExcess.Equals(""))
                            {
                                substitutionAgent.SubstitutionSet(
                                    "",
                                    ...
                                    "S",
                                    "S",
                                    bankLoanActivityEventArgs.ActUserId);
                            }
                        ...
                        else if (Master.IsSubstitutionDisabled)
                        {
                            processAgent.BankLoanPledgeRelease(
                                bankLoanActivityEventArgs.ProcessId,
                                bankLoanActivityEventArgs.BookGroup,
                        ...
                        {
                            throw (new Exception("Substitution is not ready. Substitution has not been disabled for the day. [PositionAgent.BankLoanPledgeSet]")); ;
                        }
        ...
        public void BankLoanReleaseSet(string bookGroup, string book, string processId, string loanDate, string loanType,
        ...
        private byte[] ContractsModifiedGet(string bookGroup)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public string FutureBizDate(int numberOfDays, string bizDateExchange)
        {
            int index = numberOfDays;
            string countryCode = Standard.ConfigValue("CountryCode", "US");
            DateTime bizDate = DateTime.Parse(bizDateExchange);         // Master.BizDateExchange
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
        ...
        public byte[] ContractRateHistoryGet(string bookGroup, string contractType, string secId)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public byte[] DealDataGet(short utcOffset, string userId, string functionPath, string isActive)
        {
            return DealDataGet(utcOffset, "", userId, functionPath, isActive);
        }

        public byte[] DealDataGet(short utcOffset, string dealIdPrefix, string userId, string functionPath, string isActive)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] DealDataGet(string bookGroup, string book, string dealType)
        {
        ...
        public string DealListSubmit(string bookGroup, string book, string bookContact, string dealType, string dealIdPrefix, 
                                     string comment, string list, string actUserId)
        {
        ...
        public void DealSet(string dealId, string dealStatus, string actUserId, bool isActive )
        {
                        ...
                        )
        {
            ...
            try
            {
                ...
                if (dealStatus.Equals("S") && isActive)
                {
                    ...
                    try
                    {
                        if ((Master.IsSubstitutionActive) && (dealEventArgs.DealType.Equals("L")))
                        {
                            DataSet dsBoxPositionItem = new DataSet();
                            string firmLongSettled = "";
                            long customerPosition = 0;
                            long boxPosition = 0;

                            dsBoxPositionItem = BoxPositionLookup(dealEventArgs.SecId);

                            if (dsBoxPositionItem.Tables["BoxPositionItem"].Rows.Count >= 1)
                            {
                                firmLongSettled = dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["FirmLongSettled"].ToString();

                                boxPosition = (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["ExDeficitSettled"]
                                    + (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["CustomerPledgeSettled"]
                                    + (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["FirmPledgeSettled"]
                                    - (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["DvpFailOutSettled"]
                                    - (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["BrokerFailOutSettled"]
                                    - (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["ClearingFailOutSettled"]
                                    - (long)dsBoxPositionItem.Tables["BoxPositionItem"].Rows[0]["OtherFailOutSettled"];


                                if (boxPosition >= 0) //Already free/no deficit
                                {
                                    if (long.Parse(firmLongSettled) >= long.Parse(dealEventArgs.Quantity))
                                    {
                                        customerPosition = -1;
                                    }
                                    else
                                    {
                                        customerPosition = long.Parse(dealEventArgs.Quantity) - long.Parse(firmLongSettled);
                                    }
                                }
                                else if (boxPosition < 0)
                                {
                                    boxPosition = Math.Abs(boxPosition) + long.Parse(dealEventArgs.Quantity);
                                    customerPosition = boxPosition;
                                }
                            }
                        ...
                        else if ((Master.IsSubstitutionDisabled) || ((dealEventArgs.DealType.Equals("B"))))
                        {
                            processAgent.ContractAdd(
                                dealEventArgs.DealId.ToString(),
                                dealEventArgs.BookGroup,
                        ...
                        {
                            throw (new Exception("Substition is not ready. Substituion has not been disabled for the day. [PositionAgent.DealSet]"));
                        }
        ...
        public byte[] BoxSummaryDataGet(short utcOffset, string userId, string functionPath, string bizDate)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlParameter paramUserId = null;
        ...
        public byte[] BoxFailHistoryGet(string secId)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public byte[] ContractRateComparisonDataGet(string userId, string functionPath)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public byte[] ContractRateComparisonGet(string bizDate, string bookGroup, string book, string contractType)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public byte[] ContractDataGet(short utcOffset)
        {
            return ContractDataGet(utcOffset, null, null, null);
        }
        public byte[] ContractDataGet(short utcOffset, string bizDate, string userId, string functionPath)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] ContractDataGet(short utcOffset, string bookGroup, string contractId)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] ContractDataGet(string bookGroup, string book, string contractType)
        {
            //Returns all deals by book
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public void ContractSet(string bizDate, string bookGroup, string contractId, string contractType )
        {
            ContractSet(bizDate,
                        bookGroup,
                        contractId,
        ...
        public void ContractSet(string bizDate,
                                string bookGroup,
                                string contractId,
                                string contractType,
                                string book,
        ...
        public byte[] DealsDetailDataGet(string BookGroup, string SecId, short UtcOffset)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] RecallDataGet(short utcOffset)
        {
            return RecallDataGet(utcOffset, "", "", "");
        }

        public byte[] RecallDataGet(short utcOffset, string bizDate, string userId, string functionPath)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
        ...
        public byte[] RecallActivityGet(short utcOffset, string reacallId)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public byte[] RecallIndicatorsGet()
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public byte[] RecallReasonsGet()
        {
            return RecallReasonsGet("", "");
        }

        public byte[] RecallReasonsGet(string reasonId, string reasonCode)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            SqlDataAdapter dataAdapter;
        ...
        public void RecallDelete(string bookGroup, string contractType, string book, string contractId, string recallDate,
                                int recallSequence, string lenderReference, string comment, string actUserId)
        {
        ...
        public void RecallBookContactSet(string bookGroup, string book, string bookContact, string actUserId)
        {
            string recallId = Standard.ProcessId("R");
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
        ...
        public void RecallSet(string recallId, string bookContact, string moveToDate, string action, string faxId,
                                string faxStatus, string deliveredToday, string willNeed, string actUserId, string status)
        {
            RecallEventArgs recallEventArgsItem = null;
            bool sendFax = false;
        ...
        public string ContractAdd(string bookGroup,
                                string contractType,
                                string secId,
                                string book,
                                string quantity,
