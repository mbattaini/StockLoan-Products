...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "ShortSaleService" in code, svc and config file together.
    public class ShortSaleService : IShortSale
    {
        ...
        public byte[] LocatesPreBorrowGet(string bizDate, string groupCode, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
        ...
        public byte[] TradingGroupsAccountMarkGet(string tradingGroup, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public void TradingGroupsAccountMarkSet(string groupCode, string accountNumber, string negativeRebateMarkUp, string positiveRebateMarkUp,
                                                string fedFundsMarkUp, string liborFundsMarkUp, bool delete, string actUserId)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
        ...
        public byte[] TradingGroupsOfficeCodeMarkGet(string tradingGroup, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] TradingGroupsGet(string tradeDate, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] LocateDataGet(string status, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] LocateDatesGet()
        {
            return LocateDatesGet(null);
        }

        public byte[] LocateDatesGet(string clientId)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        // For Penson.
        public byte[] LocateListGet(short utcOffset, string tradeDate)
        {
            return LocatesGet(tradeDate, null, utcOffset);
        }

        public byte[] LocateListGet(short utcOffset, string tradeDateMin, string tradeDateMax, string groupCode, string secId)
        {
            return LocatesGet(tradeDateMin, tradeDateMax, groupCode, secId, utcOffset);
        }
        // For Penson end.

        public byte[] LocatesGet(string tradeDate, short utcOffset)
        {
            return LocatesGet(tradeDate, null, utcOffset);
        }

        public byte[] LocateItemGet(string locateId, short utcOffset)
        {
        ...
        public byte[] LocatesGet(string tradeDate, string clientId, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] LocatesGet(string tradeDate, string clientId, string status, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] LocatesGet(string tradeDateMin, string tradeDateMax, string groupCode, string secId, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] BorrowHardGet(bool showHistory, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] BorrowNoGet(bool showHistory, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] ThresholdList(string effectDate)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] BorrowEasyList(string effectDate, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] InventoryHistoryLookupGet(string bizDate, string secId)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] InventoryGet(string secId, short utcOffset)
        {
            return InventoryGet(secId, utcOffset, false);
        }

        public byte[] InventoryGet(string secId, short utcOffset, bool withHistory)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] InventoryFundingRatesHistoryGet(int listCount, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] InventoryFundingRatesGet(string bizDate, short utcOffset)
        {
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
            SqlConnection dbCn = new SqlConnection(dbCnStr);
            DataSet dataSet = new DataSet();
        ...
        public byte[] InventoryRatesGet(string bizDate)
        {
            DataSet dataSet = new DataSet();
            string dbCnStr = GetDatabaseConnection("Sendero");  		//new
