...
namespace StockLoan.Locates.LocatesClientModule.Constants
{
    ...
    /// </summary>
    public class EventTopicNames : StockLoan.Locates.LocatesClientModule.Interface.Constants.EventTopicNames
    {
        /// <summary>
        /// Event fired to tell the shell to update the status panel
        /// </summary>

        public const string LocatesServerUpdate = "LocatesServerUpdate";
        public const string SplashStatusUpdate = "SplashStatusUpdate";
