...
namespace StockLoan.ComplianceData
{
    ...
    public class Master
    {
        const string APPLICATION_NAME = "ComplianceData";
        ...
        private ComplianceDataMain complianceMain;
        ...
        public Master(int logLevel, string logFilePath)
        {
            ...
            try
            {
                complianceMain = new ComplianceDataMain(dbCnStr, worldwideDbCnStr);
            }
            catch (Exception e)
            {
        ...
        public void OnStart()
        {
            ...
            KeyValue.Set("ComplianceDataServiceStartTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
        }
        ...
        public void OnStop()
        {
            ...
            KeyValue.Set("ComplianceDataServiceStopTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
        }
    }
}
