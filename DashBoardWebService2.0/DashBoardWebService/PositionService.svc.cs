...
namespace DashBoardWebService
{
    ...
    public class PositionService : IPosition
    {
        ...
        public byte[] PenaltyBoxGet(bool showHistory)
        {
            DataSet dsLockups = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            ...
            try
            {
                SqlCommand dbCmd = new SqlCommand("spBorrowPenaltyDetailGet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void PenaltyBoxCommentSet(string processId, string comment)
        {
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            try
            {
                SqlCommand dbCmd = new SqlCommand("spBorrowPenaltyCommentSet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;

                SqlParameter paramProcessId = dbCmd.Parameters.Add("@ProcessId", SqlDbType.VarChar, 12);
            ...
            {
                Log.Write(error.Message + " [PositionAgent.PenaltyBoxCommentSet]", Log.Error, 1);
                throw;
            }
            finally
            {
        ...
        public void PenaltyBoxItemSet(string secId, string actUserId, string comment)
        {
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            try
            {
        ...
        public byte[] CollateralizationUtilStartOfDayGet(string bizDate)
        {
            ...
            {
                Log.Write(error.Message + " [PositionAgent.CollateralizationUtilStartOfDayGet]", Log.Error, 1);
                throw;
            }
            finally
            {
        ...
        public byte[] CollateralizationUtilIntraDayGet(string bizDate, string priceThreshold)
        {
            DataSet dsCollateral = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            ...
            try
            {
                ...
                {
                    SqlParameter paramPriceThreshold = dbCmd.Parameters.Add("@PriceThreshold", SqlDbType.Decimal);
                    paramPriceThreshold.Value = priceThreshold;
                }

                SqlParameter paramStartOfDay = dbCmd.Parameters.Add("@StartOfDay", SqlDbType.Bit);
                paramStartOfDay.Value = true;
            ...
            {
                Log.Write(error.Message + " [PositionAgent.CollateralizationUtilIntraDayGet]", Log.Error, 1);
                throw;
            }
            finally
            {
        ...
        public byte[] BorrowsMorningGet(string bizDate)
        {
            DataSet dsBorrows = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));

            try
            {
                SqlCommand dbCmd = new SqlCommand("spBorrowsMorningGet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
                dbCmd.CommandTimeout = 12000;
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsBorrows, "Borrows");
            }
            catch (Exception error)
            {
                Log.Write(error.Message + " [PositionAgent.BorrowsMorningGet]", Log.Error, 1);
                throw;
            }
            finally
            {
            ...
            return Functions.ConvertDataSet(dsBorrows);
        }

        public void BorrowsMorningSet(string bizDate, string bookGroup, string secId, string quantity)
        {
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            try
            {
                SqlCommand dbCmd = new SqlCommand("spBorrowsMorningSet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
            ...
            {
                Log.Write(error.Message + " [PositionAgent.BorrowsMorningSet]", Log.Error, 1);
                throw;
            }
            finally
            {
        ...
        public void BorrowsMorningPurge(string bizDate)
        {
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            try
            {
                SqlCommand dbCmd = new SqlCommand("spBorrowsMorningPurge", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
            ...
            {
                Log.Write(error.Message + " [PositionAgent.BorrowsMorningPurge]", Log.Error, 1);
                throw;
            }
            finally
            {
        ...
        public byte[] CheckListGet(string bizDate)
        {
            DataSet dsCheckList = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));

            try
            {
                SqlCommand dbCmd = new SqlCommand("spCheckListGet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
                dbCmd.CommandTimeout = 12000;
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsCheckList, "CheckList");

                foreach (DataRow dr in dsCheckList.Tables[0].Rows)
                {
                    if (bool.Parse(dr["IsItemCount"].ToString()))
                    {
                        dr["ItemCount"] = ItemCountQuery(dr["ItemCountQuery"].ToString());
                    }
                }

                dsCheckList.AcceptChanges();
            }
            catch (Exception error)
            {
                Log.Write(error.Message + " [PositionAgent.CheckListGet]", Log.Error, 1);
                throw;
            }
            finally
            {
            ...
            return Functions.ConvertDataSet(dsCheckList);
        }

        private string ItemCountQuery(string query)
        {
            string output = "";
            ...
            try
            {
                SqlCommand dbCmd = new SqlCommand(query, dbCn);
        ...
        public void CheckListItemSet(string bizDate, string processId, string itemComment, string itemUserId)
        {
            SqlConnection dbCn = null;
            SqlCommand dbCmd = null;
            ...
            try
            {
                ...
                dbCn = new SqlConnection(dbCnStr);
                dbCmd = new SqlCommand("spCheckListItemCommentSe", dbCn);
                dbCmd.CommandType = CommandType.StoredProcedure;
                ...
                SqlParameter paramItemComment = dbCmd.Parameters.Add("@ItemComment", SqlDbType.VarChar, 200);
                paramItemComment.Value = itemComment;

                SqlParameter paramItemUserId = dbCmd.Parameters.Add("@ItemUserId", SqlDbType.VarChar, 50);
                paramItemUserId.Value = itemUserId;
        ...
        public string KeyValueGet(string keyId)
        {
            string keyValue = KeyValue.Get(keyId, "", GetDatabaseConnection("Sendero"));

            return keyValue;
        }
        public void KeyValueSet(string keyId, string keyValue)
        {
            KeyValue.Set(keyId, keyValue, GetDatabaseConnection("Sendero"));
        }

        public byte[] BookBalancesGet(string bizDate, string bookGroup)
        {
            DataSet dsBalances = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));

            try
            {
                SqlCommand dbCmd = new SqlCommand("spBookBalancesGet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
                dbCmd.CommandTimeout = 12000;
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsBalances, "Balances");
            }
            catch (Exception error)
            {
                Log.Write(error.Message + " [PositionAgent.BookBalancesGet]", Log.Error, 1);
                throw;
            }
            finally
            {
            ...
            return Functions.ConvertDataSet(dsBalances);
        }

        public byte[] BookCreditLBookBalancesGet(string bizDate, string bookGroup)
        {
            DataSet dsBalances = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            ...
            try
            {
                SqlCommand dbCmd = new SqlCommand("spBookCreditLBookBalancesGet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
                dbCmd.CommandTimeout = 12000;
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsBalances, "CreditBalances");
            }
            catch (Exception error)
            {
                Log.Write(error.Message + " [PositionAgent.BookBalancesGet]", Log.Error, 1);
        ...
        public byte[] RecallTradingSupplementGet(string bizDatePrior, string bizDate, string bookGroup)
        {
            DataSet dsRecalls = new System.Data.DataSet();
            SqlConnection dbCn = new SqlConnection(GetDatabaseConnection("Sendero"));
            ...
            try
            {
                SqlCommand dbCmd = new SqlCommand("spRecallTradingSupplementGet", dbCn);
                dbCmd.CommandType = System.Data.CommandType.StoredProcedure;
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter(dbCmd);
                dataAdapter.Fill(dsRecalls, "RecallTradingSupplement");
            }
            catch (Exception error)
            {
                Log.Write(error.Message + " [PositionAgent.RecallTradingSupplementGet]", Log.Error, 1);
                throw;
            }
            finally
            {
