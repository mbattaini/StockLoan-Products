...
namespace StockLoan.MemoSegData
{
  ...
  public class Master
  {
    const string APPLICATION_NAME = "MemoSegData";
    ...
    private MemoSegDataMain MemoSegDataMain;
    ...
    public Master(int logLevel, string logFilePath)
    {
      ...
      try
      { 
        MemoSegDataMain = new MemoSegDataMain(dbCnStr, worldwideDbCnStr);    // Added new argument: WorldWideDbCnStr 
      }
      catch (Exception e)
      {
    ...
    public void OnStart()
    {
      ...
      KeyValue.Set("MemoSegDataServiceStartTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
    ...
    public void OnStop()
    {
      ...
      KeyValue.Set("MemoSegDataServiceStopTime", DateTime.UtcNow.ToString(Standard.DateTimeFormat), dbCnStr);
    }
  }
}
